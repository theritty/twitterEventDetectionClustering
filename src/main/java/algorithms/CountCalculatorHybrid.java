...
public class CountCalculatorHybrid {

    public HashMap<String, Long> addNewEntryToCassCounts(CassandraDaoHybrid cassandraDao, long round, String word, String country)
    {
    ...
    public HashMap<String, Double> getCountOfWord(CassandraDaoHybrid cassandraDao, String word, long round, String country) {
    ...
    private void insertValuesToCass(CassandraDaoHybrid cassandraDao, long round, String word, String country, long count, long allcount)
    {
        try {
